...
<body>
    ...
    <section class="border-top">
            ...
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                <div class="col d-flex align-items-start">
                    <div>
                        <h2>Our Mission</h2>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed diam ipsum, placerat sed nisl
                            eu, molestie semper nunc. Fusce dictum quam sed augue gravida, vel aliquam leo feugiat. Nunc
                            consequat nisi mi, at aliquam leo convallis in. Fusce quis ultricies massa, eu placerat
                            augue. Proin finibus eget felis eu tristique.
                        </p>
                    </div>
                </div>
                <div class="col d-flex align-items-start">
        ...
        <div class="container">
            <div class="pb-5">
                <h2 class="pb-4 border-bottom">History</h2>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed diam ipsum, placerat sed nisl eu, molestie
                semper nunc. Fusce dictum quam sed augue gravida, vel aliquam leo feugiat. Nunc consequat nisi mi, at
                aliquam leo convallis in. Fusce quis ultricies massa, eu placerat augue. Proin finibus eget felis eu
                tristique. Proin interdum neque a lectus dapibus feugiat. Sed sodales mi ac sem ornare eleifend.
                Vestibulum venenatis dolor eget sodales porttitor. Ut sit amet sem velit. Mauris sodales, nisi id
                laoreet commodo, mauris massa fringilla urna, et fringilla sapien nisi ac dolor. Suspendisse sit amet
                sapien nunc. Suspendisse sagittis nisl sed suscipit fermentum. Integer elit enim, ullamcorper id commodo
                nec, efficitur quis dui. Nam a dui elit.
            </div>
        </div>
        <!-- HISTORY END -->
        ...
        <div class="container">
            <div class="pb-5">
                ...
                <p>
                    Barangay 872 is situated at approximately 14.5830, 121.0027, in the island of Luzon. Elevation at
                    these coordinates is estimated at 7.1 meters or 23.3 feet above mean sea level.
                </p>
            </div>
        </div>
        <!-- LOCATION END -->
        ...
        <div class="container">
            <div class="pb-5">
                <h2 class="pb-4 border-bottom">Directions</h2>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed diam ipsum, placerat sed nisl eu, molestie
                semper nunc. Fusce dictum quam sed augue gravida, vel aliquam leo feugiat. Nunc consequat nisi mi, at
                aliquam leo convallis in. Fusce quis ultricies massa, eu placerat augue. Proin finibus eget felis eu
                tristique. Proin interdum neque a lectus dapibus feugiat. Sed sodales mi ac sem ornare eleifend.
            ...
            <div class="container-fluid py-5">
                <div class="row px-5">
                    <div class="mx-auto col-md-3">
                        ...
                        <span class="text-muted text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Vestibulum sit amet est nibh. Nam vel erat et nisi viverra porttitor malesuada consectetur
                            nibh.</span>
                    </div>
                    <div class="mx-auto col-md-3">
