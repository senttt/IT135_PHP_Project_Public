    ...
    <div class="container py-3 px-0">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li class="nav-item"><a class="nav-link px-2 link-secondary " href="faq.php">F.A.Q.</a></li>
                <?php if ($isLogged): ?>
                <li class="nav-item">
                    <form method="POST">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            Sed tempus leo sit amet sapien tincidunt tempus. Etiam commodo eget orci a malesuada. Etiam
                            id elit vitae leo lacinia blandit ac vel justo. Nunc pretium, magna malesuada tempor
                            convallis, erat lorem commodo purus, quis lobortis mi velit eget lectus. Vestibulum
                            efficitur euismod felis, vel placerat diam porttitor et. Donec convallis pulvinar dolor, sit
                            amet venenatis risus suscipit ut. Sed eu varius urna.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
