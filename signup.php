...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $isDeceased = isset($_POST["isDeceased"]);

  // Check if all required fields are filled
  if (empty($firstName) || empty($lastName) || empty($contactNo) || empty($email) || empty($password) || empty($address) || empty($dateOfBirth) || empty($maritalStatus)) {
    $message = "Please fill in all required fields.";
  } else {
    // All required fields are filled, proceed with user registration
    $register = new Register('localhost', 'root', '', 'barangaywebsite');
    $message = $register->insertUser($firstName, $lastName, $email, $password, $contactNo, $address, $dateOfBirth, $maritalStatus, $isDeceased, 'User');
    $register->close();
  }
}
?>
...
<body>
    ...
    <section class="border-top">
        <div class="container py-5">
            <h2 class="mt-3 mb-5 text-center">Sign-up</h2>
            ...
            <form class="needs-validation" novalidate="" method="post">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" name="firstName" id="firstName" placeholder="Jose"
                            value="" required="">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="contactNo" class="form-control" name="contactNo" id="contactNo"
                    ...
                    <div class="col-sm-6">
                        <label for="dateOfBirth" class="form-label">Marital Status</label>
                    ...
                    <div class="col-12">
                        <label for="isDeceased" class form-label>Registering for the deceased?</label>
                        <input class="form-check-input" name="isDeceased" type="checkbox" value="" id="isDeceased">
                    </div>
                </div>
