    ...
    <body>
        ...
        <div class="container py-5">
            ...
            <div class="row g-3">
                ...
                <input type="text" class="form-control" id="firstName" placeholder="Jose" value="" required="">
                ...
                <input type="text" class="form-control" id="lastName" placeholder="Cruz" value="" required="">
                <div class="invalid-feedback">
                ...
                <input type="contactNo" class="form-control" id="contactNo" placeholder="09123456789">
                <div class="invalid-feedback">
                ...
                <div class="col-12">
                    ...
                    <input class="form-check-input" type="checkbox" value="" id="isDeceased">
                </div>
